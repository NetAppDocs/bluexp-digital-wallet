...
When viewing capacity-based licensing for Cloud Volumes ONTAP, the Digital Wallet now shows the licensed capacity that you purchased with marketplace private offers.
