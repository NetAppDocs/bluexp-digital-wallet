...
+
. Select the *Licenses* tab shows you each package license that you have purchased <TONIA: what else?>
+
...
+
. Select he *Subscriptions* tab to see the consumed capacity by license consumption model and includes both PAYGO and annual contract licenses. 
