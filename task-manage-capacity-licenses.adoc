...
. On the _Data service licenses_ tab, select image:screenshot_horizontal_more_button.gif[More icon] for the license you want to remove and select *Remove License*.
