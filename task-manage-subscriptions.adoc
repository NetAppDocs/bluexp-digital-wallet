...
NOTE: BlueXP supports Identity and Access Management (IAM) in standard and private mode which uses organizations to manage users and resources. If you're using BlueXP in restricted mode, then you use a BlueXP _account_ to manage users and resources, including subscriptions. 
