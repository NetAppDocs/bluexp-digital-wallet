...
[.lead]
Monitoring the health of your license and subscription status ensures that you can manage costs and maintain service as subscriptions reach expiration dates or capacity limits. 
...
YOu can also view specific information about each of your data services (including Cloud Volumes ONTAP) and drill-down into details on what subscriptions and licenses are associated with each. 

=== View details about a specific data service

The digital wallet *Overview* page allows you to drill-down into the license and subscription status for an individual data service. 
